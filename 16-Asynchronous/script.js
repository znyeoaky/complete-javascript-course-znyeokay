...
////////////// fetch & promise version + simplify function /////////////////////
// const getCountryData = function (country) {
...
///// fetch & promise version + simplify duplicate function  /////////////////////
...
//     })
//     .finally(() => {
//       countriesContainer.style.opacity = 1; // remember commend same code in renderxxx()
//     });
// };
...
//////////////// Event Loop practice ///////////////////////
// console.log("Test");
// setTimeout(() => console.log("0 sec timer", 0)); // 0 sec is not a Guarantee
...
wait(2)
  .then(() => {
    console.log("I wait for 2s");
    return wait(1);
  })
  .then(() => console.log("I wait for 1s"));
...
get3Countries("china", "canada", "tanzania");
*/
